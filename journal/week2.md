...
Given the above, there will be strech homeworks that I will abandon e.g. when too much time goes into coding. Although, one of the issues around strech homeworks is that I don't have much time left for that :).
